...
export function Hero() {
  ...
  return (
    <section
      id="hero-scroll"
      className="relative h-svh overflow-hidden bg-navy-deep"
    >
      <HeroBackground />
      <HeroScene />
      ...
      <div className="pointer-events-none absolute inset-0 z-20">
        ...
        <div className="relative mx-auto flex h-full max-w-5xl flex-col items-center px-5 pt-24 text-center sm:pt-28">
          <motion.div
